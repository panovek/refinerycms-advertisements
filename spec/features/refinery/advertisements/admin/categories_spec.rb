      ...
      describe "categories" do
        ...
        describe "categories list" do
          ...
          it "shows two items" do
            visit refinery.advertisements_admin_categories_path
        ...
        describe "create" do
          ...
          context "valid data" do
            it "should succeed" do
              ...
              expect { click_button "Save" }.to change(Refinery::Advertisements::Category, :count).from(0).to(1)
          ...
          context "invalid data" do
            it "should fail" do
              expect { click_button "Save" }.not_to change(Refinery::Advertisements::Category, :count)
        ...
        describe "destroy" do
          ...
          it "should succeed" do
            ...
            expect(Refinery::Advertisements::Category.count).to eq(0)
          end
        end
